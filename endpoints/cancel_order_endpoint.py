...
class CancelOrderEndpoint(EndpointsBase):
    """CancelOrderEndpoint - Class for cancelling orders"""

    def __init__(self, session: Session = None):
        """Initialize the CancelOrderEndpoint class
    ...
    def create_auth_token(self) -> str:
        """Create authentication token for cancelling orders
    ...
    def cancel_paid_order(self, order_id: str) -> Dict:
        """Cancel a paid order
        ...
        -------
        Dict
            The response from the cancel order request
        """
        ...
        # Use the post method from EndpointsBase to cancel the order
        cancel_url = f"{self.url}/{order_id}/cancel"
