...
class TestVouchers(TestBase):
    """Test cases for voucher functionality"""

    @pytest.mark.regression
    @pytest.mark.QABA_178
    def test_cancel_a_voucher(self):
        ...
        self.vouchers_page.select_and_cancel_a_voucher()

    @pytest.mark.regression
    @pytest.mark.QABA_176
    def test_activate_a_voucher(self):
        ...
        self.vouchers_page.select_and_activate_a_voucher()
    ...
    def test_update_a_voucher_to_not_paid(self):
    ...
    @pytest.mark.regression
    @pytest.mark.QABA_192
    def test_update_a_voucher_to_paid(self):
    ...
    def test_filter_by_custom_date_range(self):
        """Verify that a user can filter using a custom date ranger on the voucher page"""
