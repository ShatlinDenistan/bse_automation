...
class TestFinPortalManualCredit(TestBase):
    ...
    def test_add_credit_breach_credit_to_customer(self):
        ...
        self.customer_view_page.search_for_customer(100)
        ...
        self.order_credit_page.enter_jira_number()
        ...
        assert self.order_credit_page.verify_credit_is_applied(), "Credit was not applied successfully"
    ...
    def test_add_goodwill_credit_to_order(self):
        ...
        self.customer_view_page.search_for_order(74269681)
    ...
    def test_add_late_delivery_fee_credit_to_order(self):
        ...
        order_data = db_utils.get_orders_from_database("new_order_with_discount_and_shipping_amounts.sql")
        order_id = order_data["order_ids"][0]

        self.step("Search for order")
        self.customer_view_page.search_for_order(order_id)
    ...
    def test_add_system_error_credit_to_order_item(self):
        ...
        self.order_credit_page.expand_order_items_section_and_click_credit_item()
    ...
    def test_add_cod_return_credit_to_order(self):
        ...
        self.step("Get orders from database")
        db_utils = DatabaseUtils()
        order_data = db_utils.get_orders_from_database("order_with_returned_canceled_order_item.sql")
        order_id = order_data["order_ids"][0]
    ...
    def test_add_credit_error_credit_to_order(self):
        ...
        self.step("Get orders from database")
        db_utils = DatabaseUtils()
        order_data = db_utils.get_orders_from_database("canceled_order_except_auto_canceled.sql")
        order_id = order_data["order_ids"][0]
        ...
        self.order_credit_page.enter_calculated_amount(cancelled_amount)
